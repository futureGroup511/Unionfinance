...
<div id="body-one">
    <form id="form" action="${pageContext.request.contextPath}/expenditurerecord/getConditionExpendRecord/1" method="post">
            ...
            <div class="row">
                <div class="col-lg-3 col-lg-offset-3 col-md-4 col-md-offset-3 col-xs-3 col-xs-offset-3" style="margin-left:31%;">
                    ...
                    <div class="col-lg-6 col-md-6  col-xs-6">
                        <input type="text" id="calendarStart" name="date1" class="form-control" value="${date11}">
                    </div>
                </div>
                <div class="col-lg-3 col-lg-pull-1 col-md-4 col-md-pull-1 col-xs-3 col-xs-pull-1">
                    ...
                    <div class="col-lg-6 col-md-6  col-xs-6">
                        <input id="calendarEnd" type="text" name="date2" value="${date22}" class="form-control">
                    </div>
                </div>
            </div>
            <div class="row">
...
<script type="text/javascript">
    function gotoPage(pageNum){
        ...
        var url = "${pageContext.request.contextPath}/expenditurerecord/getConditionExpendRecord/" + pageNum;
