...
<h1>欢迎 ${sessionScope.user.user_name} 登陆</h1>
<br>

<h2><a href="${pageContext.request.contextPath}/user/logout">退出</a></h2>
...
<a href="${pageContext.request.contextPath}/incomerecord/getAllIncomeRecord/1">查看收入</a>
